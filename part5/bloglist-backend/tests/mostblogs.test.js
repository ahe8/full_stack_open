...
describe('author with most blogs', () => {
    ...
    const listWithDuplicateMostBlogs = [
        {
    ...
    test('when there are multiple blogs with no ties for most blogs', () => {
    ...
    test('when there are multiple blogs with ties for most blogs, return first author with most blogs', () => {
        const result = listHelper.mostBlogs(listWithDuplicateMostBlogs);
        const expected = {
            author: "Edsger W. Dijkstra",
            blogs: 3
        }
